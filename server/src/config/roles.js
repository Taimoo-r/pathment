...
const ROLES = {
  ...
  program_admin: {
    ...
    permissions: [
      ...
      P.TASK_ASSIGN, P.TASK_EDIT, P.TASK_REVIEW, P.TASK_EXTENSION, P.MENTEE_VIEW, P.MENTEE_MANAGE,
  ...
  co_mentor: {
    ...
    permissions: [
      P.TASK_ASSIGN, P.TASK_EDIT, P.TASK_REVIEW, P.TASK_EXTENSION, P.MENTEE_VIEW,
