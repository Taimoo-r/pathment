...
export const CO_MENTOR_PERMISSIONS: { key: Permission; label: string; description: string }[] = [
  ...
  { key: PERMISSIONS.TASK_EDIT, label: 'Edit tasks', description: 'Modify, cancel, reassign, or unassign tasks.' },
  { key: PERMISSIONS.TASK_REVIEW, label: 'Review work', description: 'Mark tasks complete and leave feedback.' },
  { key: PERMISSIONS.TASK_EXTENSION, label: 'Handle extensions', description: 'Approve or reject deadline extension requests.' },
